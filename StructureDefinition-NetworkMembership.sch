...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:OrganizationAffiliation/f:organization</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:OrganizationAffiliation/f:organization/f:identifier</sch:title>
    <sch:rule context="f:OrganizationAffiliation/f:organization/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:OrganizationAffiliation/f:code</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:OrganizationAffiliation/f:code/f:coding</sch:title>
    <sch:rule context="f:OrganizationAffiliation/f:code/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
