...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'fee']) &lt;= 1">extension with URL = 'fee': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'jointProject']) &lt;= 1">extension with URL = 'jointProject': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'uri']) &lt;= 1">extension with URL = 'uri': maximum cardinality of 'extension' is 1</sch:assert>
