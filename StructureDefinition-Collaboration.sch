...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'commercial']) &lt;= 1">extension with URL = 'commercial': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'nonForProfit']) &lt;= 1">extension with URL = 'nonForProfit': maximum cardinality of 'extension' is 1</sch:assert>
